...
public class MockExplorationDAOTest {
    ...
    public void testInsert() {
        Exploration exploration = new Exploration(1, 1,
                "Explored", true, false);
    ...
    public void testGetAll() {
        Exploration exploration1 = new Exploration(1, 1,
                "Explored",true, false);
        Exploration exploration2 = new Exploration(2, 2,
                "Explored", true, false);
        mockExplorationDAO.insert(exploration1);
        mockExplorationDAO.insert(exploration2);
    ...
    public void testGetByCountryId_NotFound() {
        assertNull(mockExplorationDAO.getByCountryId(100));
    }
}
