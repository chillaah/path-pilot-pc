...
//        else if (!explorationDAO.getCurrentExploring(SessionManager.getLoggedInUserId()).equals(CountryName)){
//            cancelButton.setDisable(true);
//        }
...
//        }
//        else{unlockButton.setDisable(false);}
//        //set begin exploration button as disabled if Australia is locked
...
//        }
//        else{
//            FXMLLoader fxmlLoader = new FXMLLoader(MainApplication.class.getResource(CountryName.toLowerCase() + "-view.fxml"));
//            Parent root = fxmlLoader.load();
//            Scene scene = new Scene(root, 700, 400);
//            stage.setScene(scene);
//        }
